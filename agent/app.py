...
st.caption("Synthea synthetic data · demo purposes only")
st.divider()
...
- Always return full rows of data, never just a COUNT.
- If the question asks "how many", still return the full matching rows — the app will count them and display the number automatically.
...
examples = [
    ...
    "Show patients whose HbA1c normalized in 2021",
